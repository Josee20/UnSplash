...
final class PhotoSearchViewController: UIViewController, View, Loadable, TabBarHideable {
    ...
    init(reactor: PhotoSearchReactor) {
    ...
    func bind(reactor: PhotoSearchReactor) {
        bindAction(reactor)
        bindState(reactor)
    }
