...
public final class PinterestLayout: UICollectionViewFlowLayout {
    ...
    public override func prepare() {
        ...
        let numberOfColumns: Int = columnCount // 한 행의 아이템 갯수
        ...
        for item in 0..<collectionView.numberOfItems(inSection: 0) {
            ...
            let imageHeight = delegate?.collectionView(for: collectionView, heightForAtIndexPath: indexPath) ?? 180
